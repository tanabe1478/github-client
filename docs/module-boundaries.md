...
tanabe1478/github-client (desktop composition root)
  ...
  └── github-client-repository-store ──> github-client-domain
```
...
登録repositoryのfilesystem persistenceを所有する。domainの`RepositoryRef`のみを一方向に参照する。GitHub APIとUIを参照しない。
